...
import { getUser, isMatch, update } from "../services/user.js"
...
export default function UserPage() {
    ...
    const matchPassword = async () => {
        try{
            const response = await isMatch(oldPassword, userData.id); //nova rota no back-end pra verificar se a senha inserida é igual a senha armazenada
            if(response){
